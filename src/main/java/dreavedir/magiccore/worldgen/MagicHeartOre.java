...
public class MagicHeartOre {
    public static void generate(int rates, int minHeight, int maxHeight, World world, Random random, int chunkX, int chunkZ ) {
        ...
        WorldGenMinable magicHeartOre = new WorldGenMinable(MagicCoreBlocks.blockMagicHeartOre.getDefaultState(), ModConfig.oreGenConfig.GEN_AMOUNT_MAGIC_HEART_ORE, BlockMatcher.forBlock(Blocks.STONE));
