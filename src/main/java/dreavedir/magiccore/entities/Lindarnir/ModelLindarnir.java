...
public class ModelLindarnir extends ModelBase {
    ...
    public ModelRenderer body_clothes;
    ...
    public ModelLindarnir() {
        ...
        this.hat5.addBox(-0.1F, -17.9F, -1.5F, 2, 2, 2, 0.0F);
        this.setRotateAngle(hat5, -0.045553093477052F, 0.22759093446006054F, -0.045553093477052F);
        this.staff_body_decor_1 = new ModelRenderer(this, 0, 67);
        ...
        this.hat4 = new ModelRenderer(this, 46, 57);
        this.hat4.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.hat4.addBox(-2.0F, -16.0F, -2.0F, 4, 2, 4, 0.0F);
        ...
        this.hat1.addBox(-5.0F, -9.0F, -5.0F, 10, 1, 10, 0.0F);
        ...
        this.staff_head_arm1_2 = new ModelRenderer(this, 53, 19);
        ...
        this.hat2 = new ModelRenderer(this, 28, 46);
        this.hat2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.hat2.addBox(-4.0F, -11.6F, -4.7F, 8, 3, 8, 0.0F);
        this.setRotateAngle(hat2, -0.091106186954104F, 0.0F, 0.0F);
        this.staff_body_decor = new ModelRenderer(this, 24, 66);
        ...
        this.staff_head_arm1 = new ModelRenderer(this, 44, 18);
        ...
        this.staff_head_arm1_1 = new ModelRenderer(this, 24, 19);
        ...
        this.body_clothes = new ModelRenderer(this, 0, 43);
        this.body_clothes.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.body_clothes.addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, 0.0F);
        this.staff_head = new ModelRenderer(this, 12, 68);
        ...
        this.staff_head_arm1_3 = new ModelRenderer(this, 48, 21);
        ...
        this.arm_left = new ModelRenderer(this, 44, 30);
        this.arm_left.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.arm_left.addBox(4.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
        ...
        this.arm_right = new ModelRenderer(this, 32, 18);
        this.arm_right.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.arm_right.addBox(-8.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
        ...
        this.hat3 = new ModelRenderer(this, 28, 57);
        this.hat3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.hat3.addBox(-3.0F, -14.2F, -3.6F, 6, 3, 6, 0.0F);
        ...
        this.staff_body = new ModelRenderer(this, 52, 63);
        ...
        this.staff_body_decor_2 = new ModelRenderer(this, 36, 67);
        ...
        this.body.addChild(this.body_clothes);
